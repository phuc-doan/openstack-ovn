...
NET_EXT_IP[1]=10.5.11.115
NET_EXT_NETMASK[1]=255.255.252.0
NET_EXT_IF[1]=eth0
NET_MGNT_IP[1]=20.20.1.115
NET_MGNT_NETMASK[1]=255.255.255.0
NET_MGNT_IF[1]=eth1
NET_DATAVM_IP[1]=20.20.2.115
NET_DATAVM_NETMASK[1]=255.255.255.0
NET_DATAVM_IF[1]=eth2

NET_EXT_IP[2]=10.5.11.116
NET_EXT_NETMASK[2]=255.255.252.0
NET_EXT_IF[2]=eth0
NET_MGNT_IP[2]=20.20.1.116
NET_MGNT_NETMASK[2]=255.255.255.0
NET_MGNT_IF[2]=eth1
NET_DATAVM_IP[2]=20.20.2.116
NET_DATAVM_NETMASK[2]=255.255.255.0
NET_DATAVM_IF[2]=eth2

NET_EXT_IP[3]=10.5.11.117
NET_EXT_NETMASK[3]=255.255.252.0
NET_EXT_IF[3]=eth0
NET_MGNT_IP[3]=20.20.1.117
NET_MGNT_NETMASK[3]=255.255.255.0
NET_MGNT_IF[3]=eth1
NET_DATAVM_IP[3]=20.20.2.117
NET_DATAVM_NETMASK[3]=255.255.255.0
NET_DATAVM_IF[3]=eth2
...
## Assigning IP for database node
DB_VIP=20.20.1.130

DB_EXT_IP[1]=10.5.11.131
DB_EXT_NETMASK[1]=255.255.252.0
DB_EXT_IF[1]=eth0
DB_MGNT_IP[1]=20.20.1.131
DB_MGNT_NETMASK[1]=255.255.255.0
DB_MGNT_IF[1]=eth1
DB_DATAVM_IP[1]=20.20.2.131
DB_DATAVM_NETMASK[1]=255.255.255.0
DB_DATAVM_IF[1]=eth2

DB_EXT_IP[2]=10.5.11.132
DB_EXT_NETMASK[2]=255.255.252.0
DB_EXT_IF[2]=eth0
DB_MGNT_IP[2]=20.20.1.132
DB_MGNT_NETMASK[2]=255.255.255.0
DB_MGNT_IF[2]=eth1
DB_DATAVM_IP[2]=20.20.2.132
DB_DATAVM_NETMASK[2]=255.255.255.0
DB_DATAVM_IF[2]=eth2

DB_EXT_IP[3]=10.5.11.133
DB_EXT_NETMASK[3]=255.255.252.0
DB_EXT_IF[3]=eth0
DB_MGNT_IP[3]=20.20.1.133
DB_MGNT_NETMASK[3]=255.255.255.0
DB_MGNT_IF[3]=eth1
DB_DATAVM_IP[3]=20.20.2.133
DB_DATAVM_NETMASK[3]=255.255.255.0
DB_DATAVM_IF[3]=eth2
...
HOST_NET[1]=sondx-network1
HOST_NET[2]=sondx-network2
HOST_NET[3]=sondx-network3
HOST_COM[1]=sondx-compute1
HOST_COM[2]=sondx-compute2
HOST_DB[1]=sondx-database1
HOST_DB[2]=sondx-database2
HOST_DB[3]=sondx-database3

# Password for node, node: The password for all nodes must be the same
NODE_DEFAULT_PASS="welcome123"

CTL_PASS=$NODE_DEFAULT_PASS
NET_PASS[1]=$NODE_DEFAULT_PASS
NET_PASS[2]=$NODE_DEFAULT_PASS
COM_PASS[1]=$NODE_DEFAULT_PASS
COM_PASS[2]=$NODE_DEFAULT_PASS
DB_PASS[1]=$NODE_DEFAULT_PASS
DB_PASS[2]=$NODE_DEFAULT_PASS
DB_PASS[3]=$NODE_DEFAULT_PASS
