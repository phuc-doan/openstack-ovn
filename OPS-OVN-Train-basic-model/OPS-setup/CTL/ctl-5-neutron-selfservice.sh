...
neutron_install () {
	...
	apt install neutron-server neutron-plugin-ml2 ovn-central python3-networking-ovn -y
}
...
neutron_config_ml2 () {
	...
	ops_add $ml2file ovn ovn_nb_connection tcp:$CTL_MGNT_IP:6641
	ops_add $ml2file ovn ovn_sb_connection tcp:$CTL_MGNT_IP:6642
...
ovn_config_relation () {
	...
	ovn-nbctl set-connection ptcp:6641:$CTL_MGNT_IP -- \
			set connection . inactivity_probe=60000
	ovn-sbctl set-connection ptcp:6642:$CTL_MGNT_IP -- \
			set connection . inactivity_probe=60000
}
