# 1. Tổng quan về OpenStack sử dụng OVN

# MỤC LỤC

## 1.1. Giới thiệu
\- OVN cung cấp virtual networking cho Open vSwitch và là 1 thành phần của Open vSwitch project. Project này cung cấp tích hợp giữa OpenStack Neutron và OVN.  
...
\- OpenStakc-OVN cung cấp các virtual network services:  
